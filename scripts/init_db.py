...
from models import Item, ItemTag, ItemGallery, User, Organization, Comment, Rating
...
def seed_items(category, count, type_val, title_fn, format_fn):
    items_created = 0
