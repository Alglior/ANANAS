...
_ENDPOINTS = [
    ...
    {"method": "POST",   "path": "/api/admin/qbittorrent/restart", "desc": "Relancer les téléchargements magnet en cours", "auth": True, "rate": None, "admin": True},
...
CATEGORIES = [
    ...
    {"name": "Administration", "keys": [("GET", "/admin/accueil"), ("GET", "/admin/users"),
                                         ...
                                         ("POST", "/api/admin/qbittorrent/restart"),
